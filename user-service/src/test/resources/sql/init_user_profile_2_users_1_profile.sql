insert into "user" (id, email,first_name,last_name) values (1, 'manu@reginato.com', 'Manu', 'Reginato');
insert into "user" (id, email,first_name,last_name) values (2, 'mamoru@takamura.com', 'Mamoru', 'Takamura');
